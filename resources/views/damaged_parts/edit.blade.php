                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="flex items-center mt-8">
                                    <input id="needs_replacement" type="checkbox" name="needs_replacement" class="rounded border-gray-300 text-green-600 shadow-sm focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-50" {{ old('needs_replacement', $damagedPart->needs_replacement) ? 'checked' : '' }}>
