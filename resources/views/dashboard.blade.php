            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-gray-600">{{ __('Active Auctions') }}</p>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-gray-600">{{ __('Bids Placed') }}</p>
                                <p class="text-3xl font-bold text-gray-900">0</p>
                            </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-gray-600">{{ __('Won Auctions') }}</p>
                                <p class="text-3xl font-bold text-gray-900">0</p>
                            </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-gray-600">{{ __('Account Balance') }}</p>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg lg:col-span-2">
                    <div class="p-6 border-b border-gray-200">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-lg font-medium text-gray-900">{{ __('Recent Auctions') }}</h3>
                            <a href="#" class="text-sm text-green-600 hover:text-green-700">{{ __('View All') }}</a>
                        </div>
                        ...
                        <div class="py-8 flex flex-col items-center justify-center text-center">
                            ...
                            <h4 class="text-lg font-medium text-gray-900 mb-2">{{ __('No auctions yet') }}</h4>
                            <p class="text-gray-600 mb-4">{{ __('You haven\'t participated in any auctions yet.') }}</p>
                            <a href="#" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 focus:bg-green-700 active:bg-green-800 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                {{ __('Browse Auctions') }}
                            </a>
                        </div>
                ...
                <div class="p-6 border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <a href="#" class="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                            ...
                            <span class="text-sm font-medium text-gray-900">{{ __('Create Auction') }}</span>
                        </a>
                        <a href="#" class="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                            ...
                            <span class="text-sm font-medium text-gray-900">{{ __('Browse Auctions') }}</span>
                        </a>
                        <a href="#" class="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                            ...
                            <span class="text-sm font-medium text-gray-900">{{ __('Add Funds') }}</span>
                        </a>
                        <a href="#" class="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
