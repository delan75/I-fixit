    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Edit Painting') }} - {{ $car->make }} {{ $car->model }} ({{ $car->year }})
            </h2>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('painting.update', [$car, $painting]) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <select id="painting_type" name="painting_type" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                                ...
                                <option value="full" {{ old('painting_type', $painting->painting_type) == 'full' ? 'selected' : '' }}>{{ __('Full') }}</option>
                                <option value="partial" {{ old('painting_type', $painting->painting_type) == 'partial' ? 'selected' : '' }}>{{ __('Partial') }}</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="areas_covered" name="areas_covered" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('areas_covered', $painting->areas_covered) }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="provider_name" class="block mt-1 w-full" type="text" name="provider_name" :value="old('provider_name', $painting->provider_name)" required />
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="provider_contact" class="block mt-1 w-full" type="text" name="provider_contact" :value="old('provider_contact', $painting->provider_contact)" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="material_cost" class="block mt-1 w-full" type="number" name="material_cost" :value="old('material_cost', $painting->material_cost)" min="0" step="0.01" />
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="labor_cost" class="block mt-1 w-full" type="number" name="labor_cost" :value="old('labor_cost', $painting->labor_cost)" min="0" step="0.01" />
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="total_cost" class="block mt-1 w-full" type="number" name="total_cost" :value="old('total_cost', $painting->total_cost)" min="0" step="0.01" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="start_date" class="block mt-1 w-full" type="date" name="start_date" :value="old('start_date', $painting->start_date->format('Y-m-d'))" required />
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="completion_date" class="block mt-1 w-full" type="date" name="completion_date" :value="old('completion_date', $painting->completion_date ? $painting->completion_date->format('Y-m-d') : '')" />
